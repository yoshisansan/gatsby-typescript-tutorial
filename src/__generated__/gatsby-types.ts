...
type LayoutSiteMetadataQueryVariables = Exact<{ [key: string]: never; }>;


type LayoutSiteMetadataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type AboutsiteMetadataQueryVariables = Exact<{ [key: string]: never; }>;


type AboutsiteMetadataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type MarkdownOfIndexQueryVariables = Exact<{ [key: string]: never; }>;


type MarkdownOfIndexQuery = { readonly allMarkdownRemark: (
...
type myFilesAllFileQueryVariables = Exact<{ [key: string]: never; }>;


type myFilesAllFileQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: Pick<File, 'relativePath' | 'prettySize' | 'extension' | 'birthTime'> }> } };

type blogPostRemarkQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type blogPostRemarkQuery = { readonly markdownRemark: Maybe<(
